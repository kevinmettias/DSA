...
// Harness coverage for MaximumStrongPairXORIBenchmarks (ARCHITECTURE 17.9): its two arms are
...
// place.
public sealed partial class MaximumStrongPairXORIBenchmarksTests
{
    ...
    private static MaximumStrongPairXORIBenchmarks BuildHarness()
    {
        var harness = new MaximumStrongPairXORIBenchmarks { Length = SmallestLength };
        harness.Setup();
