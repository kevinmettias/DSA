...
public sealed partial class DisjointSetTests
{
    ...
    public void Union_TwoIds_MakesThemConnected()
    {
        ...
        set.Union(0, 1);
        var unioned = set.IsConnected(0, 1);
        var untouched = set.IsConnected(0, 2);
    ...
    public void Union_ChainOfPairs_MergesAllIntoOneSet()
    {
        ...
        set.Union(1, 2);
        set.Union(2, 3);
        var chained = set.IsConnected(0, 3);
        var untouched = set.IsConnected(0, 4);
    ...
    public void Union_AlreadyConnectedIds_IsANoOp()
    {
        ...
        set.Union(1, 0);
        var stillConnected = set.IsConnected(0, 1);
    ...
    [Fact]
    public void IsConnected_SameId_IsAlwaysTrue()
    {
        var set = new DisjointSetOperations(3);

        var connected = set.IsConnected(1, 1);
    ...
    public void Union_ManyElements_ProducesExactlyTheExpectedPartition()
    {
        ...
        for (var id = 0; id < 5; id++)
        {
            var withinFirstGroup = set.IsConnected(0, id);
            var acrossGroups = set.IsConnected(0, id + 5);
