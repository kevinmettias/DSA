...
public sealed class ZeroHeuristicTests
{
    ...
    {
        Assert.Equal(0, ZeroHeuristic<WeightedGridNode, int>.Estimate(new WeightedGridNode(3, 9), new WeightedGridNode(0, 0)));
    }

    [Fact]
    public void Estimate_NullTarget_IsAlsoZero()
    {
        Assert.Equal(0, ZeroHeuristic<WeightedGridNode, int>.Estimate(new WeightedGridNode(1, 1), null));
    }

    [Fact]
    public void Estimate_IsZeroForEveryWeightType()
    {
        Assert.Equal(0d, ZeroHeuristic<WeightedGridNode, double>.Estimate(new WeightedGridNode(2, 2), null));
    }
