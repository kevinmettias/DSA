...
// library constrains TNode : class, the same reason DataStructures.Graph.Grids' GridNode is a
// class. Record equality still does the right thing for visited-tracking: two
// JumpGridNodes at the same coordinate on the same Grid compare equal.
