...
public sealed partial class DistinctSubsequencesTests
{
    ...
    public void NumDistinct_LeetCodeExamples_ReturnsCount(string source, string target, int expected) { var actual = Count(source, target); Assert.Equal(expected, actual); }
