...
public sealed class FindConsecutiveIntegersFromADataStreamTests
{
    public static TheoryData<int, int, int[], bool[]> Examples =>
        new()
        {
            ...
            // Fewer than k arrivals can never be an answer, however many match.
            { 1, 5, [1, 1], [false, false] },
