...
{
    [Fact] public void IsSameTree_IdenticalTrees_ReturnsTrue() => Assert.True(IsSame(Tree(), Tree()));
    [Fact] public void IsSameTree_DifferentShape_ReturnsFalse() => Assert.False(IsSame(new BinaryTreeNode<int>(1) { Left = new(2) }, new BinaryTreeNode<int>(1) { Right = new(2) }));
