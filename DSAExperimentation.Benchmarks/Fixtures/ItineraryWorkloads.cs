...
// pinned to ReconstructItinerarySolution.Start ("JFK") so the synthetic graph is
// actually reachable from LeetCode's fixed starting airport.
internal static class ItineraryWorkloads
{
    ...
    public static string[][] BuildTickets(int ticketCount, int seed)
    {
        ...
        airports[0] = ReconstructItinerarySolution.Start;
