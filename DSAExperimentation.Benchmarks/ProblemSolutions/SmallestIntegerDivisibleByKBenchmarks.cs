...
public class SmallestIntegerDivisibleByKBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _graph = RemainderGraph.Build(Divisor);

    [Benchmark(Baseline = true)]
    public int ModularWalk() => SmallestIntegerDivisibleByKSolution.SmallestRepunitLengthByModularWalk(Divisor);
