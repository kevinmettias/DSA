...
public class MinimumNumberOfDaysToEatNOrangesBenchmarks
{
    ...
    public int UnmemoizedRecursion() =>
        MinimumNumberOfDaysToEatNOrangesSolution.MinDaysByUnmemoizedRecursion(OrangeCount);

    [Benchmark]
    public int MemoizedRecurrence() =>
        MinimumNumberOfDaysToEatNOrangesSolution.MinDaysByMemoizedRecurrence(OrangeCount);
}
