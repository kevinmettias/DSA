...
// worst case for an unmemoized walk and the best case for memoization. SlotCount stays
...
public class MaximumAndSumOfArrayBenchmarks
{
    ...
    public int BruteForceRecursion() =>
        MaximumAndSumOfArraySolution.MaximumAndSumByBruteForceRecursion(_nums, SlotCount);

    [Benchmark]
    public int MemoizedRecursion() =>
        MaximumAndSumOfArraySolution.MaximumAndSumByMemoizedBitmask(_nums, SlotCount);
}
