...
public class WordSearchBenchmarks
{
    ...
    public bool CanTraceWordByBruteForceDfs() => WordSearchSolution.CanTraceWordByBruteForceDfs(_board, TargetWord);

    [Benchmark]
    public bool CanTraceWordByBacktrack() => WordSearchSolution.CanTraceWordByBacktrack(_board, TargetWord);
}
