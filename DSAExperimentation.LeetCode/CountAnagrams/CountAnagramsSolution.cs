...
// LeetCode 2514. Count Anagrams: split sentence into words on ' '; the number of
// "good" strings is the product, over every word, of that word's distinct-letter-
...
internal static class CountAnagramsSolution
{
    ...
    public static long CountAnagramsByBruteForce(string sentence)
    {
        var answer = 1L;
    ...
    public static long CountAnagramsByModularFactorial(string sentence)
    {
