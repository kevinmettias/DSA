...
// it out and start the next one from scratch. If `text` ends mid-segment while
...
internal static class PartitionStringSolution
{
    ...
    // itself against.
    public static List<string> PartitionByHashSetScan(string text)
    {
    ...
    public static List<string> PartitionBySetScan(string text)
    {
