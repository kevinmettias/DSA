...
// LeetCode 1409. Queries on a Permutation With Key: P starts as [1..permutationSize]; each
...
internal static class QueriesOnAPermutationWithKeySolution
{
    ...
    public static List<int> AnswerQueriesByListMoveToFront(int[] queries, int permutationSize)
    {
        var permutation = new List<int>(permutationSize);

        for (var value = FirstPermutationValue; value <= permutationSize; value++)
        {
    ...
    public static List<int> AnswerQueriesByDynamicArrayMoveToFront(int[] queries, int permutationSize)
    {
