...
// strictly smaller Dist (RestrictedPathChildTopology's own weaker condition, for LC
// 1786, counts a looser family of "monotonically-closer" walks that need not be
// shortest at all - this problem counts only shortest paths). Every road takes
// positive time, so Dist still strictly decreases along every accepted edge, which
// is what keeps this acyclic and a valid IDagTopology witness.
