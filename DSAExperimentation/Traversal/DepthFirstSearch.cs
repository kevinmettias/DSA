...
internal static class DepthFirstSearch
{
        ...
        where TNode : notnull
    {
        ...
        var pending = new DSAExperimentation.Collections.Stack.Stack<TNode>();
    ...
    private static void PushUnvisitedSuccessors<TNode>(
        DSAExperimentation.Collections.Stack.Stack<TNode> pending, HashSet<TNode> visited, IEnumerable<TNode> successors)
        where TNode : notnull
    {
